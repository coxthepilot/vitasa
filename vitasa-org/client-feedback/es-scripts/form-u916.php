...
function postUserFeedback($form) {
	$workedWell = $_POST['custom_U923'];
	$toImprove = $_POST['custom_U5786'];
	$siteVisited = $_POST['custom_U5798'];
	$contact = $_POST['custom_U6969'];

//	echo('site: '.$siteVisited.'<br/>');
//	echo('well: '.$workedWell.'<br/>');
//	echo('improve: '.$toImprove.'<br/>');
