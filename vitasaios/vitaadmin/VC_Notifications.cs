...
namespace vitaadmin
{
    public partial class VC_Notifications : UIViewController
    {
		C_Global Global;
		...
		public VC_Notifications (IntPtr handle) : base (handle)
        {
        }
        ...
        void NotificationsTableDelegate_NotificationsTableRowSelect(object sender, vitaadmin.VC_Notifications.C_NotificationsTableDelegate.C_NotificationsTableEvent a)
        {

        }

        void NotificationsTableDelegate_NotificationsTableRowDeselect(object sender, vitaadmin.VC_Notifications.C_NotificationsTableDelegate.C_NotificationsTableEvent a)
        {

        }

        void NotificationsTableDelegate_NotificationsTableRowRemove(object sender, vitaadmin.VC_Notifications.C_NotificationsTableDelegate.C_NotificationsTableEvent a)
        {
		...
		public class C_NotificationsTableSource : UITableViewSource
		{
			...
			public override UITableViewCell GetCell(UITableView tableView, NSIndexPath indexPath)
			{
                ...
                cell.TextLabel.Text = not.Text;
				//cell.DetailTextLabel.Text = not.
