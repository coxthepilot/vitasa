...
namespace vitavol
{
    public partial class VC_AdminSiteCalendar : UIViewController
    {
        C_Global Global;
        ...
        public VC_AdminSiteCalendar (IntPtr handle) : base (handle)
        {
        }
        ...
        public override void ViewDidLoad()
        {
            ...
            B_Back.TouchUpInside += (sender, e) => 
                PerformSegue("Segue_AdminSiteCalendarToAdminSite", this);

            B_Save.TouchUpInside += (sender, e) => 
                PerformSegue("Segue_AdminSiteCalendarToAdminSite", this);

            B_ResetCalendar.TouchUpInside += (sender, e) => 
                PerformSegue("Segue_AdminSiteCalToAdminSiteCalReset", this);
            ...
            B_MonthNext.TouchUpInside += (sender, e) =>
            {
                ...
                DateState = BuildDateStateArray(Global.CalendarDate, Global.SelectedSiteTemp);
            ...
            Task.Run(() =>
            {
                ...
                new Action(() =>
                {
                    ...
                    CollectionViewHelper.DateTouched += (sender, e) =>
                    {
                        ...
                        PerformSegue("Segue_AdminSiteCalendarToAdminSiteCalDetails", this);
                    };
                }));
            });
        }
