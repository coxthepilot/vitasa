...
namespace vitavol
{
    [Register ("VC_AdminSiteCalendar")]
    partial class VC_AdminSiteCalendar
    {
        [Outlet]
        ...
        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        UIKit.UIButton B_ResetCalendar { get; set; }
        ...
        void ReleaseDesignerOutlets ()
        {
            ...
            if (B_ResetCalendar != null) {
                B_ResetCalendar.Dispose ();
                B_ResetCalendar = null;
            }
